[![PushTrain build success](http://localhost:90/badge/sedevops/drone-test/status.svg)](https://api.github.com/repos/sedevops/drone-test) [![Managed by PushTrain](http://localhost:90/badge-text/managed_by-PushTrain-purple.svg)](https://swiftengine.io)
